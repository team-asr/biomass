...
@Contract(
        ...
        info = @Info(
                ...
                contact = @Contact(
                        email = "team-asr@as-research.org",
                        name = "Moses gichangA",
                        url = "https://as-research.org")))
@Default
public final class BiomassTransfer implements ContractInterface {

    private final Genson genson = new Genson();

    private enum BiomassTransferErrors {
        BIOMASS_NOT_FOUND,
        BIOMASS_ALREADY_EXISTS
    }

    /**
     * Creates some initial biomass on the ledger.
     *
    ...
    public void InitLedger(final Context ctx) {
        ...
        CreateAsset(ctx, "Coffee Tree Prunning", "blue", 5, "Tomoko", 300);
        CreateAsset(ctx, "Coffee Husks", "red", 5, "Brad", 400);
        CreateAsset(ctx, "Mukinduri", "green", 10, "Jin Soo", 500);
    ...
    /**
     * Creates new biomass types on the ledger.
     *
     * @param ctx the transaction context
